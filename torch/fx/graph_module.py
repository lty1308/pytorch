...
def _print_readable(module, module_name, print_output=True, include_stride=False, include_device=False):
    graph = module.graph
...
"""
    ...
    def print_readable(self, print_output=True, include_stride=False, include_device=False):
        ...
        return _print_readable(
            self, self._get_name(), print_output, include_stride, include_device
        )
